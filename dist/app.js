...
$(document).ready(function () {
  ...
  $('.author-select-php').change(function () {
    ...
    $('.cds-container.ajax-call').html(''); // prendo il valore del autore disco dalla option select
  ...
  function printCds(arrayObjects) {
    ...
    var template = Handlebars.compile(source); // Ciclo sul array
  ...
  function callFiltredCds(author) {
    ...
    $.ajax({
      ...
      success: function success(filtredCds) {
...
__webpack_require__(/*! C:\Users\Alfa\Desktop\Boolean Project\php\php-ajax-dischi\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Alfa\Desktop\Boolean Project\php\php-ajax-dischi\src\scss\app.scss */"./src/scss/app.scss");
